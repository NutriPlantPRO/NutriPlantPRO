...
(function (root, factory) {
  ...
  var phrases = {
    ...
    'La barrita ajusta el %. También puedes escribir el número.': 'The bar sets the %. You can also type the number.',
    'Ajustar %': 'Set %',
...
'Estimaciones de referencia, no mediciones certificadas ni declaraciones oficiales. Al usar aceptas la': 'Reference estimates, not certified measurements or official declarations. By using this you accept',
    ...
    'Modelo CPK cargado. Arrastra para rotar 360°, usa zoom y selecciona un átomo para ver su nombre.': 'CPK model loaded. Drag to rotate 360°, use zoom and select an atom to see its name.',
    'Modelo 3D CPK: arrastra para rotar 360°, rueda/pinza para zoom. Selecciona un átomo para ver su nombre.': 'CPK 3D model: drag to rotate 360°, wheel/pinch to zoom. Select an atom to see its name.',
    'Cargando estructura 3D desde PubChem...': 'Loading 3D structure from PubChem...',
    'El visor 3D requiere conexión para cargar 3Dmol.js. La tarjeta científica queda disponible sin conexión.': 'The 3D viewer needs a connection to load 3Dmol.js. The scientific card remains available offline.',
    'No se pudo cargar el modelo 3D desde PubChem. Abre la fuente:': 'Could not load the 3D model from PubChem. Open the source:',
    'Arrastra para rotar, usa zoom y doble clic para recentrar.': 'Drag to rotate, use zoom and double-click to recenter.',
    'N amínico': 'Amino N',
    ...
    '1 · Programa del ciclo': '1 · Cycle program',
    '2 · Diseño objetivo': '2 · Target design',
    '3 · Aporte fertilizantes': '3 · Fertilizer supply',
    '1 · Diseño objetivo': '1 · Target design',
    '2 · Aporte fertilizantes': '2 · Fertilizer supply',
    '📊 Programa del ciclo': '📊 Cycle program',
    'Programa del ciclo': 'Cycle program',
    'Arma etapas con título libre (Etapa 1, Floración…). Puedes partir del <strong>catálogo</strong> por etapa (Steiner, Hoagland…), editar meq/ppm, <strong>arrastrar</strong> el ternario y ver las <strong>gráficas</strong>. Con <strong>Al catálogo</strong> guardas toda la tabla como un programa (te pide un título).':
      'Build stages with free titles (Stage 1, Flowering…). Load a <strong>catalog</strong> solution per stage (Steiner, Hoagland…), edit meq/ppm, <strong>drag</strong> the ternary and see the <strong>charts</strong>. Use <strong>To catalog</strong> to save the whole table as a program (it asks for a title).',
    'Arma etapas con título libre (Etapa 1, Floración…). Puedes partir del': 'Build stages with free titles (Stage 1, Flowering…). Start from the',
    'catálogo': 'catalog',
    '(Steiner, Hoagland… o las tuyas), editar meq/ppm,': '(Steiner, Hoagland… or your own), edit meq/ppm,',
    'arrastrar': 'drag',
    'el ternario de la etapa activa (igual que en Diseño) y ver las': 'the ternary of the active stage (same as Design) and see the',
    'gráficas': 'charts',
    'del ciclo.': 'of the cycle.',
    'Guarda una etapa en': 'Save a stage to',
    'tu catálogo': 'your catalog',
    'para usarla en cualquier proyecto (con cuenta).': 'to use it in any project (with an account).',
    'Arma etapas con título libre (Etapa 1, Floración…). Puedes partir del catálogo (Steiner, Hoagland… o las tuyas), editar meq/ppm, arrastrar el ternario de la etapa activa (igual que en Diseño) y ver las gráficas del ciclo. Guarda una etapa en tu catálogo para usarla en cualquier proyecto (con cuenta).': 'Build stages with free titles (Stage 1, Flowering…). Start from the catalog (Steiner, Hoagland… or your own), edit meq/ppm, drag the ternary of the active stage (same as Design) and see the cycle charts. Save a stage to your catalog to use it in any project (with an account).',
    '+ Agregar etapa': '+ Add stage',
    'Agregar etapa': 'Add stage',
    'Usar etapa activa en Diseño': 'Use active stage in Design',
    'Etapas del ciclo': 'Cycle stages',
    'Mis programas': 'My programs',
    'Al catálogo': 'To catalog',
    'Guarda todas las etapas de la tabla en tu catálogo': 'Save all stages in the table to your catalog',
    'Mis programas del ciclo': 'My cycle programs',
    'Carga un programa completo (todas las etapas) o elimínalo del catálogo.': 'Load a full program (all stages) or delete it from the catalog.',
    'Aún no tienes programas guardados. Usa «Al catálogo» para guardar toda la tabla.': 'You have no saved programs yet. Use “To catalog” to save the whole table.',
    'Título del programa del ciclo (se guardan todas las etapas de la tabla):': 'Cycle program title (all stages in the table will be saved):',
    'Necesitas un título para guardar el programa.': 'You need a title to save the program.',
    'Agrega al menos una etapa antes de guardar.': 'Add at least one stage before saving.',
    'Cargar': 'Load',
    'Eliminar': 'Delete',
    'Programa': 'Program',
    'etapas': 'stages',
    'Etapa activa': 'Active stage',
    'Cargar una solución del catálogo en esta etapa': 'Load a catalog solution into this stage',
    'cuenta / nube, sin límite': 'account / cloud, no limit',
    'límite versión gratis': 'free version limit',
    'Prefloración': 'Pre-flowering',
    'Producción': 'Production',
    'Vegetativa': 'Vegetative',
    'Floración': 'Flowering',
    'CE': 'EC',
    'Diagrama ternario (etapa activa)': 'Ternary diagram (active stage)',
    'Gráfica meq/L (macros)': 'meq/L chart (macros)',
    'Gráfica ppm (micros)': 'ppm chart (micros)',
    'Catálogo': 'Catalog',
    'Guardar esta etapa en tu catálogo de soluciones': 'Save this stage to your solution catalog',
    'Quitar': 'Remove',
    'Etapa': 'Stage',
    'Mis soluciones': 'My solutions',
    'Literatura': 'Literature',
    'Catálogo de soluciones nutritivas': 'Nutrient solution catalog',
    'Macros en meq/L y micros en ppm. Elegir copia valores a la etapa (puedes editar después).': 'Macros in meq/L and micros in ppm. Choose copies values into the stage (you can edit after).',
    'Macros en meq/L y micros en ppm.': 'Macros in meq/L and micros in ppm.',
    'Solución': 'Solution',
    'Seleccionado': 'Selected',
    'Elegir': 'Choose',
    'propia': 'custom',
    'disponibles en cualquier proyecto (con cuenta)': 'available in any project (with account)',
    'Deja al menos una etapa.': 'Keep at least one stage.',
    'Ponle un título a la etapa antes de guardarla en el catálogo.': 'Give the stage a title before saving it to the catalog.',
    'Guardada en tu catálogo de soluciones.': 'Saved to your nutrient solution catalog.',
    'Selecciona una etapa en la tabla.': 'Select a stage in the table.',
    'Agrega etapas para ver la gráfica.': 'Add stages to see the chart.',
    'Metales': 'Metals',
    'Con B / Cu': 'With B / Cu',
    'Perfil': 'Profile',
    'del total': 'of total',
    'Pasa el cursor por una etapa: relaciones + perfil fenológico.': 'Hover a stage: ratios + phenology profile.',
    'Pasa el cursor por una etapa: relaciones entre micros (ppm).': 'Hover a stage: micronutrient ratios (ppm).',
    'Pasa el cursor por una etapa: relaciones + perfil fenológico estimado.': 'Hover a stage: ratios + estimated phenology profile.',
  ...
  function translateAttrs(el) {
    ...
    ['placeholder', 'title', 'aria-label', 'data-np-tooltip', 'data-label'].forEach(function (name) {
