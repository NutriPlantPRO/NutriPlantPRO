...
(function (root, factory) {
  ...
  var EN = {
    ...
    soil_adj_floor: 'Floor',
    soil_adj_floor_title: 'If soil covers more than extraction, at least this % of extraction remains (fertigation maintenance). Then efficiency applies. 0% = no floor.',
    ...
    req_step_3: 'Correct for soil supply or deficit (floor: nutrients are not zeroed)',
    ...
    dist_h2_hint: 'Choose Week or Month for the fertigation calculation. Edit the %; the dose ({unit}) comes from the requirement. The % must sum to 100%. Arrows: 1% · Shift+arrows: 5% · Alt: 0.1%. You can still type decimals. Use Support below to start a shape, then fine-tune.',
    dist_pct_nudge: 'Arrows: 1% · Shift: 5% · Alt: 0.1%. Decimals can be typed.',
    dist_assist_title: 'Support (then edit): start a shape or copy % from another nutrient.',
    ...
    dist_h4: '4. Chart',
    dist_chart_drag: 'This chart is the Objective distribution %. Drag a point or edit the % table. Tap a curve or its name below to highlight it. Dragging compensates the other stages to 100%. kg/ha is recalculated. If you edit doses in the Program (same periods), the % here updates too.',
