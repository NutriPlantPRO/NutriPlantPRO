...
(function (root, factory) {
  ...
  var EN = {
    ...
    dist_h4: '4. Chart',
    dist_chart_drag: 'Drag a point to adjust the %. Tap a curve or its name below to highlight it when curves overlap. The other stages are compensated to 100%. kg/ha is recalculated; if the program has the same periods, fertilizers are adjusted too.',
