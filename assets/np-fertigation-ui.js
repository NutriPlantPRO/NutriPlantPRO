...
(function (root, factory) {
  ...
  var EN = {
    ...
    dist_h2_hint: 'Choose Week or Month for the fertigation calculation. Edit the %; the dose ({unit}) is what remains for fertigation after water and granular/base supply. The % must sum to 100%. Arrows: 1% · Shift+arrows: 5% · Alt: 0.1%. You can still type decimals. On each nutrient title, ▾ starts a shape; then fine-tune.',
    ...
    dist_credit_hint: 'The shown dose is what remains for fertigation: stage target minus {sources}.',
    dist_kg_net_title: 'Remaining for fertigation: target {target} − water {water} − granular {base}.',
