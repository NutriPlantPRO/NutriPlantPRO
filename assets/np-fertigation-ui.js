...
(function (root, factory) {
  ...
  var EN = {
    ...
    dist_update_catalog: '💾 Update in catalog',
    dist_saved: '✅ Curve added to catalog',
    dist_updated: '✅ Curve updated in catalog',
    dist_deleted: '🗑 Curve removed from catalog',
    dist_save_wait: '⏳ Already saved. Wait a moment before pressing again.',
    dist_save_need_title: '⚠️ Give the curve a title before saving it to the catalog.',
