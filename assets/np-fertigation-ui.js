...
(function (root, factory) {
  ...
  var EN = {
    ...
    dist_chart_drag: 'This chart is the Objective distribution %. Drag a point or edit the % table. Tap a curve or its name to view it alone. Dragging compensates the other stages to 100%. If you edit doses in the Program (same periods), the % here updates too.',
    dist_chart_focus: 'Only this curve. Drag its points; tap its name or the chart background to show all.',
    dist_macros: 'Macros',
    dist_micros: 'Micros',
    dist_stage: 'Stage',
