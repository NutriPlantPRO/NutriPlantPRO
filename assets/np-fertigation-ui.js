...
(function (root, factory) {
  ...
  var EN = {
    ...
    dist_suggest_hint: 'Suggest % fills a new curve from the stages (does not change the program). If a program already exists, % follows it automatically. If you change a rate, the % table and chart move. Arrows 1% · Shift 5% · Alt 0.1%. ▾ copies shapes.',
