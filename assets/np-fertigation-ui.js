...
(function (root, factory) {
  ...
  var EN = {
    ...
    dist_h2_hint: 'Choose Week or Month. Edit only the % (must sum to 100% per nutrient). Requirement, water and granular are already shown above; this table does not show kg, to avoid mixing them. Arrows: 1% · Shift: 5% · Alt: 0.1%. Select the stages and tap Suggest %; ▾ also starts a shape.',
    ...
    dist_suggest_hint: 'Suggest % builds a new curve (triangles). Fit % from program keeps the program as it is and only matches the %. This table does not show kg.',
    dist_from_program: 'Fit % from program',
    dist_from_program_title: 'Takes the stages and actual program supply and sets the % as it is today.',
    dist_from_program_done: 'Percentages fitted to the current program. The program was not changed.',
    dist_from_program_none: 'This project does not have program rates yet.',
