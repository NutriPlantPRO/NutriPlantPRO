...
(function (root, factory) {
  ...
  var EN = {
    ...
    dist_lead: 'Split actual requirement by phenological stage. Doses ({unit}) come from the table above; here you design the %.',
    ...
    dist_h2_hint: 'Each nutrient must sum to 100%.',
