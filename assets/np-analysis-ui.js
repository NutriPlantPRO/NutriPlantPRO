...
(function (root, factory) {
  ...
  var phrases = {
    ...
    'Relaciones nutrimentales': 'Nutrient ratios',
    'Relación real = resultado A / resultado B. Relación ideal = óptimo A / óptimo B; si editas un óptimo, la ideal se recalcula. En P/Zn y Ca/B el macro (% MS) se pasa a ppm (×10 000). Desviación = ((real − ideal) / ideal) × 100; misma regla visual que DOP.': 'Actual ratio = result A / result B. Ideal ratio = optimum A / optimum B; if you edit an optimum, the ideal updates. For P/Zn and Ca/B the macro (% DM) is converted to ppm (×10,000). Deviation = ((actual − ideal) / ideal) × 100; same visual rule as DOP.',
    'Ingresa resultado del análisis y, si quieres, ajusta el óptimo.': 'Enter the lab result and, if you want, adjust the optimum.',
    'Valor (lab) (ppm)': 'Lab value (ppm)',
    'Valor (lab)': 'Lab value',
    'Micronutrientes': 'Micronutrients',
    'Micronutrientes (ppm)': 'Micronutrients (ppm)',
    ...
    '− corregir durante el ciclo': '− correct during the cycle',
    '+ aporte potencial del suelo': '+ potential soil contribution',
    '− falta': '− deficit',
    '+ exceso': '+ excess',
    'falta': 'deficit',
    'exceso': 'excess',
    ...
    'Resultado (%)': 'Result (%)',
    'Óptimo (%)': 'Optimum (%)',
    'Resultado (ppm)': 'Result (ppm)',
    'Óptimo (ppm)': 'Optimum (ppm)',
