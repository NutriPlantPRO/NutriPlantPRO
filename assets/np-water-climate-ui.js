...
(function (root, factory) {
  ...
  var phrases = {
    ...
    'Rendimiento hídrico (ISH)': 'Hydric yield (ISH)',
    ...
    'Sin valor': 'No value',
    'Fp (exceso)': 'Fp (excess)',
    'Sin Kc no hay ETc ni ISH. Usa el botón': 'Without Kc there is no ETc or ISH. Use the',
    ...
    'Índice de Satisfacción Hídrica (ISH)': 'Water Satisfaction Index (ISH)',
    ...
    'validar en campo': 'validate in the field',
    'El ISH y la curva son una': 'ISH and the curve are an',
    'estimación': 'estimate',
    ...
    'techo hídrico tocado (estrés fuerte en el modelo). Ese semáforo es el mismo del resultado ISH — no un veredicto de rendimiento comercial.': 'hydric ceiling hit (strong model stress). Same bands as the ISH result — not a commercial yield verdict.',
    'D = déficit · E = exceso · ISH = 100 × [1 − Σ(D + Fp·E) / Σ ETc]': 'D = deficit · E = excess · ISH = 100 × [1 − Σ(D + Fp·E) / Σ ETc]',
    '% del riego aplicado que cuenta en el ISH': '% of applied irrigation used in ISH',
