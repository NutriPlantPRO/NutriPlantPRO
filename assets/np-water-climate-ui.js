...
(function (root, factory) {
  ...
  var definitions = {
    ...
    spacing: { canonical: 'm', metric: 'm', us_customary: 'ft' },
    dose_mass_area: { canonical: 'kg/ha', metric: 'kg/ha', us_customary: 'lb/acre' },
    concentration_mass_volume: { canonical: 'kg/m3', metric: 'kg/m3', us_customary: 'lb/1000 US gal' },
    small_area: { canonical: 'cm2', metric: 'cm2', us_customary: 'in2' },
  ...
  var phrases = {
    ...
    'Ventanas de Aplicación Foliar': 'Foliar Application Windows',
    'Uniformidad de riego': 'Irrigation uniformity',
    'Una sola zona / un lote.': 'A single zone / one plot.',
    'Clasifica hora por hora si el ambiente favorece cobertura, permanencia y absorción.': 'Classifies hour by hour whether conditions favor coverage, persistence and uptake.',
    'Reduce deriva, evaporación de la gota y lavado por lluvia.': 'Reduces drift, droplet evaporation and rain wash-off.',
    'Nombre del lote (opcional)': 'Plot name (optional)',
    'Obtener ventanas de pulverización': 'Get spray windows',
    '2 · Variables evaluadas': '2 · Variables scored',
    'Sweet spot de aplicación (intersección)': 'Application sweet spot (intersection)',
    'Rangos del criterio clásico de pulverización.': 'Classic spray-window ranges.',
    'Muy favorable': 'Very favorable',
    'Reduce riesgo de deriva': 'Lowers drift risk',
    'Disminuye evaporación de la gota': 'Lowers droplet evaporation',
    'Evita lavado por lluvia': 'Avoids rain wash-off',
    'Mejora permanencia y absorción foliar': 'Improves foliar persistence and uptake',
    'Ajustar rangos (producto / cultivo)': 'Adjust ranges (product / crop)',
    'Restaurar sweet spot': 'Restore sweet spot',
    'Usar banda publicación NutriPlant': 'Use NutriPlant publication band',
    '3 · Matriz horaria': '3 · Hourly matrix',
    '24 horas (incluye noche)': '24 hours (night included)',
    'Mejores ventanas': 'Best windows',
    'Intensidad': 'Intensity',
    'Mejor': 'Best',
    'Peor': 'Worst',
    '4 · Interpretación de la hora': '4 · Hour interpretation',
    'Clave agronómica: no solo importa aplicar, sino aplicar cuando el ambiente favorece cobertura, permanencia y absorción.': 'Agronomic key: it is not only about spraying, but spraying when the environment favors coverage, persistence and uptake.',
    'Campo · DU / CU': 'Field · DU / CU',
    'Diseño · EU Keller–Karmeli': 'Design · Keller–Karmeli EU',
    'Qué mediste': 'What you measured',
    'Unidad de las muestras': 'Sample unit',
    'Tiempo de captura (min)': 'Catch time (min)',
    'Horas de riego del evento': 'Irrigation hours of the event',
    'Lotes y muestras': 'Plots and samples',
    'Ejemplo de campo': 'Field example',
    'Uniformidad de emisión (diseño)': 'Emission uniformity (design)',
    ...
    'Rendimiento hídrico (ISH)': 'Hydric yield (WSI)',
    ISH: 'WSI',
    'Calcular ISH': 'Calculate WSI',
    'Pestaña ISH no disponible.': 'WSI tab not available.',
    'Indica Kc para calcular ETc e ISH': 'Enter Kc to compute ETc and WSI',
    'Tabla semanal (editable)': 'Weekly table (editable)',
    'Rendimiento agrícola': 'Agricultural yield',
    'Evolución del techo de rendimiento por agua en el ciclo.': 'Water-related yield ceiling over the crop cycle.',
    '% efectivo del riego': 'Irrigation effective %',
    'Porcentaje efectivo del riego': 'Irrigation effective percentage',
    'Ubicación del predio': 'Field location',
    'Mapa, GPS o lat/lng (como en VPD).': 'Map, GPS or lat/lng (same as VPD).',
    'Latitud': 'Latitude',
    'Longitud': 'Longitude',
    'Usar mi ubicación': 'Use my location',
    'Mi ubicación': 'My location',
    'Obtener lluvia y ET₀': 'Get rainfall and ET₀',
    'Obtener lluvia y ET₀ del ciclo': 'Get cycle rainfall and ET₀',
    'Fecha inicio': 'Start date',
    'Fecha fin (vacío = hoy)': 'End date (empty = today)',
    'Macrotúnel / invernadero (lluvia = 0)': 'Macro-tunnel / greenhouse (rain = 0)',
    'ISH del ciclo': 'Cycle WSI',
    'ISH acum.': 'Cum. WSI',
    'Fp (exceso)': 'Fp (excess)',
    'Déficit': 'Deficit',
    'Exceso': 'Excess',
    'déficit': 'deficit',
    'exceso': 'excess',
    'Déficit hídrico de la semana': 'Weekly water deficit',
    'Exceso hídrico de la semana': 'Weekly water excess',
    'faltó agua vs ETc': 'water short vs ETc',
    'sobró agua vs ETc': 'water surplus vs ETc',
    'D = déficit (faltó agua vs ETc) · E = exceso (sobraba agua vs ETc).':
      'D = deficit (water short vs ETc) · E = excess (water surplus vs ETc).',
    'Déficit = faltó agua vs ETc · Exceso = sobró agua vs ETc.':
      'Deficit = water short vs ETc · Excess = water surplus vs ETc.',
    'Semana': 'Week',
    'Lluvia': 'Rain',
    'Riego': 'Irrigation',
    'Ciclo y Kc': 'Cycle and Kc',
    'Kc del cultivo': 'Crop Kc',
    'Sin valor': 'No value',
    'Fp (exceso)': 'Fp (excess)',
    'Sin Kc no hay ETc ni ISH. Usa el botón': 'Without Kc there is no ETc or WSI. Use the',
    'Rangos FAO': 'FAO ranges',
    'Puedes sobrescribir lluvia y ET₀ con datos de campo. Riego opcional: captura en lámina o volumen por área (lado a lado). La columna': 'You can overwrite rain and ET₀ with field data. Optional irrigation: enter depth or volume per area (side by side). The',
    'es el techo de rendimiento relativo:': 'column is the relative yield ceiling:',
    'solo baja': 'only falls',
    'Estimado metodológico.': 'Methodological estimate.',
    'Lectura del % que aparece:': 'How to read the % shown:',
    'Estima el': 'Estimates the',
    'Índice de Satisfacción Hídrica (ISH)': 'Water Satisfaction Index (WSI)',
    'del ciclo: qué % del techo de rendimiento sostiene el agua.': 'for the cycle: what % of the yield ceiling water can sustain.',
    'Usa clima satelital (o pluviómetro / ET₀ de campo), Kc y riego opcional por': 'Uses satellite climate (or rain gauge / field ET₀), Kc and optional irrigation by',
    'semana': 'week',
    'máx. 52': 'max. 52',
    'Estimación de referencia —': 'Reference estimate —',
    'validar en campo': 'validate in the field',
    'El ISH y la curva son una': 'WSI and the curve are an',
    'estimación': 'estimate',
    'según esta fórmula (balance semanal lluvia/riego vs ETc, con Fp en excesos). Orientan el techo de rendimiento': 'from this formula (weekly rain/irrigation vs ETc balance, with Fp on excess). They indicate the',
    'relativo al agua': 'water-related yield ceiling',
    'no predicen la cosecha real': 'do not predict actual harvest',
    '(también pesan nutrición, sanidad, variedad, suelo, manejo). Validar siempre en campo.': '(nutrition, pests, variety, soil and management also matter). Always validate in the field.',
    'agua casi no limita': 'water barely limiting',
    'estrés acumulado': 'accumulated stress',
    'techo hídrico tocado (estrés fuerte en el modelo). Ese semáforo es el mismo del resultado ISH — no un veredicto de rendimiento comercial.': 'hydric ceiling hit (strong model stress). Same bands as the WSI result — not a commercial yield verdict.',
    'D = déficit · E = exceso · ISH = 100 × [1 − Σ(D + Fp·E) / Σ ETc]': 'D = deficit · E = excess · WSI = 100 × [1 − Σ(D + Fp·E) / Σ ETc]',
    '% del riego aplicado que cuenta en el ISH': '% of applied irrigation used in WSI',
    ...
    'Gráfica rendimiento agrícola': 'Agricultural yield chart',
    'Ventanas de Aplicación Foliar': 'Foliar Application Windows',
    'Contexto agronómico para identificar los mejores horarios de pulverización': 'Agronomic context to identify the best spray hours',
    'Una sola zona / un lote.': 'One zone / one plot.',
    'Clasifica hora por hora si el ambiente favorece cobertura, permanencia y absorción.': 'Classifies hour by hour whether conditions favor coverage, persistence and uptake.',
    'Nombre del lote (opcional)': 'Plot name (optional)',
    'Lote 1': 'Plot 1',
    'Obtener ventanas de pulverización': 'Get spray windows',
    'Mostrar 24 h': 'Show 24 h',
    '24 horas (incluye noche)': '24 hours (night included)',
    'Sweet spot de aplicación (intersección)': 'Application sweet spot (intersection)',
    'Restaurar rangos de la publicación': 'Restore publication ranges',
    'Usar banda publicación NutriPlant': 'Use NutriPlant publication band',
    'Mejores ventanas': 'Best windows',
    'Intensidad': 'Intensity',
    'Mejor': 'Best',
    'Peor': 'Worst',
    'Matriz horaria': 'Hourly matrix',
    'Interpretación de la hora': 'Hour interpretation',
    'Variables evaluadas': 'Variables evaluated',
    ...
    'Sin lluvia inmediata': 'No immediate rain',
    'Elige un punto, genera el clima y toca una hora.': 'Pick a point, fetch weather and tap an hour.',
    'No hay horas favorables en el periodo visible.': 'No favorable hours in the visible period.',
    'Las mejores ventanas suelen concentrarse en la mañana y al final de la tarde, cuando bajan el DPV y el viento.': 'The best windows usually concentrate in the morning and late afternoon, when VPD and wind drop.',
    'Clave agronómica: no solo importa aplicar, sino aplicar cuando el ambiente favorece cobertura, permanencia y absorción.': 'Agronomic key: it is not only about spraying, but spraying when the environment favors coverage, persistence and uptake.',
    'Estimación satelital en un punto. Validar en campo. No sustituye etiqueta del producto.': 'Satellite estimate at one point. Validate in the field. Does not replace the product label.',
