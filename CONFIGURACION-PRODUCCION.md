...
| `NUTRIPLANT_PUBLIC_MCP_OAUTH_SECRET` | Firma OAuth del plugin público ChatGPT (`/mcp`) | **Opcional.** Si no está, se deriva de `AGROCLIMATE_TOKEN_SECRET` (no usar el token Socio) |
