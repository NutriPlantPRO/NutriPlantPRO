...
- Capítulos `analisis-solucion-nutritiva-lab.html` y `analisis-extracto-pasta.html` (ES/EN): columna **% meq** junto a meq (todos los iones del grupo; ≠ Steiner); fila **Total** = Σ meq + 100; semáforo vs Ideal ±10 % o vs Ref. Admin + PDF usan el mismo render.
