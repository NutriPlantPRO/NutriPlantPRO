...
**Herramienta 📊 — pasos:** (1) Extracción total kg/ha por nutriente. (2) % por etapa (suma 100 %/nutriente; etapas editables; cada celda − / + y barrita). (3) Resultado kg/ha etapa = total × (%/100). (4) Gráfica macros/micros.
