...
- **Calculadora** (misma lógica que pestaña **Clima → Lluvia/Riego** del proyecto):
  ...
  - **Riego en franja regada (periodo):** mm = lámina en zona humedecida; m³ = volumen total aplicado en esa franja.
...
- **Resultados:** déficit climático, ETc, déficit cultivo, riego aplicado, **balance** en mm y m³. Balance = **déficit m³ cultivo − riego m³ en franja** (no restar mm de franja directo al mm cultivo sin convertir volumen).
