...
2 PROYECTOS: search_projects; project_detail; project_vpd_live; project_climate; project_analyses. Clima vivo: project_climate mode=saved|live|rainfall_refresh|rolling|**all** (si piden «actualizado»). VPD: project_vpd_live.
