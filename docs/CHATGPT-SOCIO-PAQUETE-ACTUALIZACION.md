...
1. `docs/HERRAMIENTAS-GRATUITAS-CONOCIMIENTO-GPT.md` ← balance hídrico m³ (2026-06-20) + conversor alcance raíz
2. `docs/ANALISIS-LABORATORIO-CONOCIMIENTO-GPT.md`
3. `docs/MANUAL-TECNICO-CONOCIMIENTO-GPT.md` ← manual web **v2026.06.1** (**23 capítulos**; balance hídrico riego Clima corregido 2026-06-20; re-subir tras cada tanda)
